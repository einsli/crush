...
func quickStyle(o quickStyleOpts) Styles {
	...
	// Dialog.Quit
	s.Dialog.Quit.Content = lipgloss.NewStyle().Foreground(o.fgBase).Bold(true)
	s.Dialog.Quit.Hint = lipgloss.NewStyle().Foreground(o.fgBase)
	s.Dialog.Quit.Frame = lipgloss.NewStyle().Foreground(o.fgBase).BorderForeground(o.primary).Border(lipgloss.RoundedBorder()).Padding(1, 2)
